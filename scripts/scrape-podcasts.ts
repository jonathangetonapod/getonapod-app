...
const TOP_20_CATEGORIES = [
  ...
  'ct_m68b3l5q85x7k4rp',  // Entrepreneurship
  'ct_3krv4dnrrqn79l6o',  // Technology
  'ct_lxbp9dwoak5aeom7',  // True Crime
  'ct_z9majpn4r5o73bx8',  // Comedy
  'ct_2v89gony7jnrqj3d',  // News
  'ct_zqbe76njppnyjx43',  // Self-Improvement
  'ct_akrev35b8454ypql',  // Health
  'ct_7v9m4lnk9wx6jkap',  // Investing
  'ct_6vqzjd52vw8xlep3',  // Marketing
  'ct_6vqzjd529vn8xlep',  // Sports
  'ct_o9mjlawxzonkdy3r',  // Entertainment
  'ct_6olr4e5ek5b7yj2a',  // Education
  'ct_vy2zbpn3gwq3m7gx',  // Interviews
  'ct_ox4amd5dkpneyq2r',  // Fitness
  'ct_rzemq35ldjn9x27d',  // Personal Development
  'ct_lxbp9dwodk5aeom7',  // Mental Health
  'ct_m68b3l5q68nx7k4r',  // Politics
  'ct_3pk7q259ebwvr4bx',  // Science
  'ct_2v89gonyg4nrqj3d',  // Productivity
]
...
async function searchPodcasts(page: number = 1): Promise<PodscanSearchResponse> {
  ...
  console.log(`   URL: ${PODSCAN_API_URL}/podcasts/search?${params.toString()}`)
...
async function scrapePodcasts() {
  ...
  console.log(`🎯 Target: 300 podcasts from top 20 categories`)
  console.log(`📊 Filters: English, min 3000 audience size\n`)
  ...
  try {
    while (totalScraped < targetCount) {
      ...
      totalScraped += response.podcasts.length
