              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setManualOpen(false)
                    clearCredential()
                    navigate(workspaceModuleHref(selectedWorkspaceBaseHref(workspaceId), 'overview'))
                  }}
                >
                  Open workspace
                </Button>
