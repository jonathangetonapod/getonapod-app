...
BEGIN
  FOREACH required_function IN ARRAY ARRAY[
    ...
    'public.claim_workspace_staff_password_reset_v1(uuid,uuid,uuid,bigint,uuid,uuid)',
    'public.cancel_workspace_staff_password_reset_v1(uuid,uuid,uuid,bigint,uuid,uuid)',
    'public.complete_workspace_staff_password_reset_v1(uuid,uuid,uuid,bigint,uuid,uuid,bigint)',
